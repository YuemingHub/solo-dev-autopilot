...
2. 加载 skills：把 `.claude/skills/` 复制到 `.codex/skills/`（Codex 的 skills 目录约定，21 个 SKILL.md 均为官方格式）。
...
- superpowers 是 Claude Code 插件市场的方法论底座；Codex 侧的方法论由 21 个 Skill + 9 步闭环 + creating-forward 协议层承担，不强制安装 superpowers。
