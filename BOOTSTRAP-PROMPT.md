...
- 如果是 B（已有项目）：问清楚项目在哪个文件夹 → 引导我把 `.claude/skills/`（21 个 SKILL.md）和 `templates/` 复制到项目里 → 读取或生成 PROJECT-MEMORY.md、CODEMAP.md、SESSION_DRIVER.md → 告诉我上次做到哪、今天先做什么
...
└── B 已有项目
      ↓ 你说项目文件夹位置
      → AI 复制 .claude/skills/ + templates/ 过去
      → AI 读取/生成 3 个记忆文件
